    ...
    return (
        <div id="about">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <img src={require("../../img/noun_secure_3323085.svg").default} alt="" />
            ...
            the voter's internet address</p>
                        ...
                        <div className=" col-lg-4 col-sm-6">
                            <img src={require("../../img/add_task_black_24dp.svg").default} alt="" />
            ...
            and online convenience boost participation for busy owners</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <img src={require("../../img/savings_black_24dp.svg").default} alt="" />
                            <h3>Save Money</h3>
            ...
            manual hand counts. Conduct multiple votes annually</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <img src={require("../../img/noun_Audit_2404408.svg").default} alt="" />
                            <h3>Auditable</h3>
            ...
            in the fianl vote count</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <img src={require("../../img/noun_precision_3528990.svg").default} alt="" />
                            <h3>Precision</h3>
            ...
            publication of results, with receipt of vote for each vote cast.</p>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <img src={require("../../img/noun_Mobile_2496108.svg").default} alt="" />
                            <h3>Mobile Reaady</h3>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="card">
                                <img src={require("../../img/Seal_of_the_President_of_Nigeria.svg.svg").default} alt="" />
                                <h3>PRESIDENCY</h3>
                            </div>
                        </div>
                        <div className=" col-lg-3 col-sm-6">
                            <div className="card">
                                <img src={require("../../img/senate.svg").default} alt="" />
                                <h3>SENATE</h3>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6">
                            <div className="card">
                                <img src={require("../../img/Coat_of_arms_of_Nigeria.svg.svg").default} alt="" />
                                <h3>GOVERNORSHIP</h3>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6">
                            <div className="card">
                                <img src={require("../../img/Seal_of_the_House_of_Representatives_of_Nigeria.svg.svg").default} alt="" />
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div className="col-lg-12 col-12">
                                <img src={require("../../img/noun_register_3698254.svg").default} alt="" />
                                <h3>Register</h3>
            ...
            voting system.</p>
                            ...
                            <div className=" col-lg-12 col-12">
                                <img src={require("../../img/noun_Vote_1361375.svg").default} alt="" />
                                <h3>Vote</h3>
            ...
            their voting choices. Then all they need to do is click on the “vote” button.</p>
                            ...
                            <div className="col-lg-12 col-12">
                                <img src={require("../../img/noun_verification_1654914.svg").default} alt="" />
                                <h3>Verification</h3>
                                <p>Voters in any category, without a valid VIN can still vote,but their votes will be recorded
                                as
            ‘ineligible votes’.</p>
                            </div>
                        </div>
            ...
            <div className="container-fluid values">
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="card2">
                                <img src={require("../../img/noun_mirror_3950030.svg").default} alt="" />
                                <h3>Transparency</h3>
                            </div>
                        </div>
                        <div className=" col-lg-3 col-sm-6">
                            <div className="card2">
                                <img src={require("../../img/noun_One_2817940.svg").default} alt="" />
                                <h3>Integrity</h3>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6">
                            <div className="card2">
                                <img src={require("../../img/noun_Handshake_562118.svg").default} alt="" />
                                <h3>Respect</h3>
                            </div>
                        </div>
                        <div className="col-lg-3 col-sm-6">
                            <div className="card2">
                                <img src={require("../../img/noun_Scale_3244382.svg").default} alt="" />
                                <h3>Truth</h3>
                            </div>
                        </div>
                    </div>
            ...
            <div className="container-fluid start">
                <div className="row">
                    <div className="col-lg-6 col-sm-6">
                        <img src={require("../../img/shutterstock_1798399480.svg").default} alt="" />
                    </div>
